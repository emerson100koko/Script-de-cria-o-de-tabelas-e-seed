...
CREATE TABLE tb_vinho (
	...
	FOREIGN KEY (vinicola_id) REFERENCES tb_vinicola
);
...
INSERT INTO tb_vinicola (nome, descricao, fone, email, regiao_id) VALUES ('Garibaldi', 'Vinícola situada na serra gaucha', '9822-3344', 'garibaldi@gmail.com', 2);
...
INSERT INTO tb_vinho (nome, tipo_id, preco, vinicola_id) VALUES ('Eduarda', 1, 55.5, 3);
